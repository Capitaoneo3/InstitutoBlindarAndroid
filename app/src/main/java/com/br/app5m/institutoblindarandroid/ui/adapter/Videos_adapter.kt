...
class Videos_adapter (private val messageList: List<Message>, val clickListener: RecyclerItemClickListener, context: Context):
    RecyclerView.Adapter<Videos_adapter.FileHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FileHolder {
        ...
        return FileHolder(LayoutInflater.from(parent.context).inflate(R.layout.adapter_videos, parent, false))
    }
...
*/
        ...
        fileHolder.ll_he.setOnClickListener { clickListener.onClickListenerVideosAdapter(message) }
